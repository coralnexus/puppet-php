...
class php::params {
  ...
  case $::operatingsystem {
    /(Ubuntu|Debian)/: {
      ...
      $cli_package_version    = 'present'
      $cli_ini_source         = undef
      $cli_ini_content        = 'php/cli.php.ini.erb'

      $pear_package_name      = 'php-pear'
      $pear_package_version   = 'present'
      ...
      $apache2_ini_content    = 'php/apache.php.ini.erb'
      $apache_package_name    = "libapache2-mod-php5"
      $apache_package_version = 'present'
